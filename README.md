...
| `src/index.ts`         | The main **Vue** entry point. This bootstraps the Vue application.                                |
...
| `src/game/index.ts`    | The main **game** entry point. This contains the game configuration and starts the game.          |
